...
public class DynamicObject implements ILevelObject {

    protected Body<IDataObject> body;
    protected boolean isAlive = true;
    private Material material;

    public DynamicObject(float x, float y, Shape shape, Material material) {
        shape.setDensity(material.density());
        shape.setFriction(material.friction());
        shape.setRestitution(material.friction());
        this.material = material;
        body = new DynamicBody<IDataObject>(shape, x, y);
